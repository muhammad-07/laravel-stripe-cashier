...
<form method="POST" action="{{ isset($userDetail) ? route('user-details.update', $userDetail->id) : route('user-details.store') }}">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-floating form-floating-outline mb-3">
                <input type="text" class="form-control" id="g_firstname" name="g_firstname" value="{{ old('g-firstname', isset($userDetail) ? $userDetail->g_firstname : '') }}" placeholder="Enter guardian's first name">
                <label for="g_firstname">Guardian's First Name</label>
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-floating form-floating-outline mb-3">
                <input type="text" class="form-control" id="g_last_name" name="g_last_name" value="{{ old('g-lastname', isset($userDetail) ? $userDetail->g_lastname : '') }}" placeholder="Enter guardian's last name">
                <label for="g_lastname">Guardian's Last Name</label>
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-floating form-floating-outline mb-3">
                <input type="tel" class="form-control" id="g_phone" name="g_phone" value="{{ old('g-phone', isset($userDetail) ? $userDetail->g_phone : '') }}" placeholder="Enter guardian's phone number">
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="form-floating form-floating-outline mb-3">
                <input type="text" class="form-control" id="g_address" name="g_address" value="{{ old('g-address', isset($userDetail) ? $userDetail->g_address : '') }}" placeholder="Enter guardian's address">
                <label for="g_address">Guardian's Address</label>
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-floating form-floating-outline mb-3">
                <input type="text" class="form-control" id="g_postalcode" name="g_postalcode" value="{{ old('g-postalcode', isset($userDetail) ? $userDetail->g_postalcode : '') }}" placeholder="Enter guardian's postal code">
                <label for="g_postalcode">Guardian's Postal Code</label>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-4">
            <div class="form-floating form-floating-outline mb-3">
                <input type="text" class="form-control" id="g_city" name="g_city" value="{{ old('g-city', isset($userDetail) ? $userDetail->g_city : '') }}" placeholder="Enter guardian's city">
        ...
        <div class="col-md-4">
            <div class="form-floating form-floating-outline mb-3">
                <input type="text" class="form-control" id="g_state" name="g_state" value="{{ old('g-state', isset($userDetail) ? $userDetail->g_state : '') }}" placeholder="Enter guardian's state">
        ...
        <div class="col-md-4">
            <div class="form-floating form-floating-outline mb-3">
                <input type="email" class="form-control" id="g_email" name="g_email" value="{{ old('g-email', isset($userDetail) ? $userDetail->g_email : '') }}" placeholder="Enter guardian's email">
